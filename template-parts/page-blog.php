                     ...
                     <?php if ($query->max_num_pages > 1): ?>
                        <div class="blog__tabs-pagination">
                            ...
                            echo paginate_links(array(
                                ...
                                'prev_text' => '<img src="' . AIRDROP_THEME_DIRECTORY . '/assets/images/arrow-left.svg" alt="arrow left">',
                                'next_text' => '<img src="' . AIRDROP_THEME_DIRECTORY . '/assets/images/arrow-rigth.svg" alt="arrow right">',
                            ));
                            ?>
                        </div>
                    <?php endif; ?>
