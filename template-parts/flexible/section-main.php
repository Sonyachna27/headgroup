<?php 
    ...
    $main_choice_services = get_sub_field('main_choice_services');
?>
        ...
        <div class="central__container">
            <div class="central__top">
                ...
                <div class="central__top__right">
                    <?php 
                        if($main_choice_services) :
                        foreach ($main_choice_services as $main_choice_service) { ?>
                            <a href="<?= get_the_permalink($main_choice_service -> ID) ?>" class="simple"><?= $main_choice_service -> post_title ?></a>
                    <?php }
                        endif; 
                    ?>
                </div>
