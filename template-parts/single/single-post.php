...
<div class="page-wrap mb-m">
	<div class="main-content">
		...
		<?php } ?>
					...
					<div class="coins">
						<?php foreach ( $tags as $tag ) { ?>
							<a href="<?= get_tag_link( $tag->term_id ); ?>">
								<img src="<?= AIRDROP_THEME_DIRECTORY ?>/assets/images/coins.svg" alt="<?= esc_attr( $tag->name ); ?>">
								<?= esc_html( $tag->name ); ?>
							</a>
						<?php } ?>
					</div>
			...
			<h1><?= the_title(); ?></h1>
			<div class="author">
				<img src="<?= AIRDROP_THEME_DIRECTORY ?>/assets/images/author-logo.svg" alt="Nikita Vyshinsky">
            ...
            <div class="news-item">
                ...
                <div class="news-item-wrap">
                    <div class="coins">
                        ...
                        ?>
                            <a href="<?= get_tag_link($tag->term_id); ?>">
                                <img src="<?= AIRDROP_THEME_DIRECTORY ?>/assets/images/coins.svg" alt="coins">
                                <?= $tag->name; ?>
                            </a>
                        <?php
                                    $tags_count++;
            ...
            <div class="faq__accord-item accord-item">
                <div class="faq__accord-item-top accord-item-top">
                    ...
                    <div class="icon-wrapper">
                        <img class="initial-state" src="<?= AIRDROP_THEME_DIRECTORY ?>/assets/images/initial-state.svg" alt="icon">
                        <img class="hover-state" src="<?= AIRDROP_THEME_DIRECTORY ?>/assets/images/hover-state.svg" alt="icon">
